...
const resources = {
  kk: {
    translation: {
      invite_title: 'Құрметті ағайын-туыс, бауырлар, құда-жекжат, нағашы-жиен, бөлелер, құрбы-құрдас, дос-жарандар, әріптестер, көршілер!',
      invite_names: 'Санжар мен Айгерім',
      invite_message: 'Сіздерді балаларымыз үйлену тойына арналған салтанатты ақ дастарханымыздың қадірлі қонағы болуға шақырамыз!',
      invite_text: 'үйлену тойына арналған салтанатты ақ дастарханымыздың қадірлі қонағы болуға шақырамыз!',
      ...
      program: [
        ...
        { time: '21:00', title: 'Кешкі тәттілер' },
  ...
  ru: {
    translation: {
      ...
      rsvp_attendance_label: 'Придёте/придёду на свадьбу?',
